...
time_series_collector.main(crypto_tickers, "datasetsIn/crypto-daily")
print(f"Time series are collected in {time.time() - start_time} seconds.")

start_time = time.time()
print("Merging time series...")
time_series_merger.main("datasetsIn/crypto", "datasetsOut/crypto", "daily", 20, 2190)
print(f"Time series are merged in {time.time() - start_time} seconds.")

start_time = time.time()
print("Marking weeks...")
week_marker.main("datasetsOut/crypto/daily_20_2190.csv")
