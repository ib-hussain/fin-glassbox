...
class SingleStep:
    ...
    def run_train_only(self):
        ...
        try:
            ...
            for epoch in tqdm(range(1, self.epochs + 1), desc="train_single_step.py > epoch"):
                ...
                val_loss, val_rae, val_corr, val_mape, val_mae, val_rmse, val_a20 = (evaluate(
                    self.data,
                    self.data.valid[0],
                    self.data.valid[1],
                    self.model,
                ...
                print(
                    "| end of epoch {:3d} | time: {:5.2f}s | train_loss {:5.4f} | valid rse {:5.4f} | valid rae {:5.4f} | valid corr {:5.4f} | valid mape {:5.4f} | valid a20 {:5.4f}"
                    .format(
                        epoch,
                ...
                if epoch % 5 == 0:
                    ...
                    print(
                        "test rse {:5.4f} | test rae {:5.4f} | test corr {:5.4f} | test mape {:5.4f} | test mae {:5.4f} | test rmse {:5.4f} | test_a20 {:5.4f}"
                        .format(
                            test_loss,
                            test_rae,
                            test_corr,
        ...
        print(
            f"Validation mape for best loss: {best_validation_mape_for_best_loss}",
            flush=True,
        )
    ...
    def evaluate_the_best_model(self):
        ...
        test_acc, test_rae, test_corr, test_mape, test_mae, test_rmse, test_a20 = (evaluate(
            self.data,
            self.data.test[0],
            self.data.test[1],
            model,
        ...
        print("final test rse {:5.4f} | test rae {:5.4f} | test corr {:5.4f} | test mape {:5.4f} | test a20 {:5.4f}".
              format(test_acc, test_rae, test_corr, test_mape, test_a20))
        return (
            vtest_acc,
            vtest_rae,
            vtest_corr,
