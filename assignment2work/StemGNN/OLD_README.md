This is forked and adapted for our studies from [StemGNN](https://github.com/microsoft/StemGNN.git).
...
To install python dependencies, virtualenv is recommended, `sudo apt install python3.7-venv` to install virtualenv for python3.7. All the python dependencies are verified for `pip==20.1.1`. Run the following commands to create a venv and install python dependencies:

```setup
python3.7 -m venv venv
source venv/bin/activate
pip install numpy==1.19.5 setuptools==41.2.0 scipy==1.5.4 pandas==1.1.5 torch==1.8.0 tqdm~=4.66.1
```
